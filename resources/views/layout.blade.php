...
<body class="bg-gray-100 dark:bg-gray-900">
    <!-- Navbar -->
    <nav class="bg-red-900 dark:bg-gray-900 fixed top-0 left-0 w-full z-50">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <h1 class="text-2xl font-bold text-white dark:text-white">Student Management System</h1>
        </div>
    </nav>
